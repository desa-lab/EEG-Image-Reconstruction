...
for im_id in range(len(pred_vision)):
    ...
    if not osp.exists('results/versatile_diffusion1b_refclip/{}/'.format(sub)):
        os.makedirs('results/versatile_diffusion1b_refclip/{}/'.format(sub))
    x[0].save('results/versatile_diffusion1b_refclip/{}/{}.png'.format(sub,im_id))
