...
train_latents = np.load('cache/eyetracking_data/simonPilotResults/extracted_embeddings/train_autokl.npy', mmap_mode='r')
test_latents = np.load('cache/eyetracking_data/simonPilotResults/extracted_embeddings/test_autokl.npy', mmap_mode='r')
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
# np.save(save_dir + 'eyetracking_regress_autokl.npy', pred_latents)
np.save(save_dir + 'eyetracking_regress_autokl_delay.npy', pred_latents)
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
# np.save(save_dir + 'eyetracking_regress_autokl_weights.npy', pred_latents)
np.save(save_dir + 'eyetracking_regress_autokl_weights_delay.npy', pred_latents)
