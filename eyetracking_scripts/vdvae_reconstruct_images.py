...
image_path = 'data/eyetracking_data/simonPilotResults/test_img_ts.npy'
...
# pred_latents = np.load('cache/eyetracking_data/simonPilotResults/predicted_embeddings/eyetracking_regress_autokl.npy')
pred_latents = np.load('cache/eyetracking_data/simonPilotResults/predicted_embeddings/eyetracking_regress_autokl_delay.npy')
ref_latent = stats
...
for i in range(int(np.ceil(len(test_images)/batch_size))):
  ...
  for j in range(len(sample_from_latent)):
      ...
      # subject = 'BIGMEG1'
      # save_dir = 'results/eyetracking_data/simonPilotResults/vdvae/' 
      # if not os.path.exists(save_dir):
      #     os.makedirs(save_dir)
      # im.save('results/eyetracking_data/simonPilotResults/vdvae/{}.png'.format(i*batch_size+j))
      # save_dir = 'results/eyetracking_data/simonPilotResults/vdvae_ts/' 
      # if not os.path.exists(save_dir):
      #     os.makedirs(save_dir)
      # im.save('results/eyetracking_data/simonPilotResults/vdvae_ts/{}.png'.format(i*batch_size+j))
      save_dir = 'results/eyetracking_data/simonPilotResults/vdvae_ts_delay/' 
      if not os.path.exists(save_dir):
          os.makedirs(save_dir)
      im.save('results/eyetracking_data/simonPilotResults/vdvae_ts_delay/{}.png'.format(i*batch_size+j))
