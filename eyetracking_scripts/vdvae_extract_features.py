...
# image_path = 'data/eyetracking_data/simonPilotResults/train_img.npy'
image_path = 'data/eyetracking_data/simonPilotResults/train_img_ts.npy'
...
# image_path = 'data/eyetracking_data/simonPilotResults/test_img.npy'
...
if not os.path.exists('cache/eyetracking_data/simonPilotResults/extracted_embeddings'):
    os.makedirs('cache/eyetracking_data/simonPilotResults/extracted_embeddings')
np.save('cache/eyetracking_data/simonPilotResults/extracted_embeddings/train_autokl.npy', train_latents)
np.save('cache/eyetracking_data/simonPilotResults/extracted_embeddings/test_autokl.npy', test_latents)
