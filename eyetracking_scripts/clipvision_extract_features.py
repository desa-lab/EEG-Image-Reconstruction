...
with torch.no_grad():
    ...
    np.save('cache/eyetracking_data/simonPilotResults/extracted_embeddings/test_clipvision.npy',test_clip)
    ...
    np.save('cache/eyetracking_data/simonPilotResults/extracted_embeddings/train_clipvision.npy',train_clip)
