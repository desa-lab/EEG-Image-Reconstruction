...
# pred_text = np.load('cache/eyetracking_data/simonPilotResults/predicted_embeddings/eyetracking_regress_cliptext.npy')
pred_text = np.load('cache/eyetracking_data/simonPilotResults/predicted_embeddings/eyetracking_regress_cliptext_delay.npy')
...
# pred_vision = np.load('cache/eyetracking_data/simonPilotResults/predicted_embeddings/eyetracking_regress_clipvision.npy')
pred_vision = np.load('cache/eyetracking_data/simonPilotResults/predicted_embeddings/eyetracking_regress_clipvision_delay.npy')
...
for im_id in range(len(pred_vision)):
    ...
    # zim = Image.open('results/eyetracking_data/simonPilotResults/vdvae/{}.png'.format(im_id))
    # zim = Image.open('results/eyetracking_data/simonPilotResults/vdvae_ts/{}.png'.format(im_id))
    zim = Image.open('results/eyetracking_data/simonPilotResults/vdvae_ts_delay/{}.png'.format(im_id))
    ...
    # if not osp.exists('results/eyetracking_data/simonPilotResults/versatile_diffusion/'):
    #     os.makedirs('results/eyetracking_data/simonPilotResults/versatile_diffusion/')
    # x[0].save('results/eyetracking_data/simonPilotResults/versatile_diffusion/{}.png'.format(im_id))
        
    # if not osp.exists('results/eyetracking_data/simonPilotResults/versatile_diffusion_ts/'):
    #     os.makedirs('results/eyetracking_data/simonPilotResults/versatile_diffusion_ts/')
    # x[0].save('results/eyetracking_data/simonPilotResults/versatile_diffusion_ts/{}.png'.format(im_id))
        
    if not osp.exists('results/eyetracking_data/simonPilotResults/versatile_diffusion_ts_delay/'):
        os.makedirs('results/eyetracking_data/simonPilotResults/versatile_diffusion_ts_delay/')
    x[0].save('results/eyetracking_data/simonPilotResults/versatile_diffusion_ts_delay/{}.png'.format(im_id))
