...
train_clip = np.load('cache/eyetracking_data/simonPilotResults/extracted_embeddings/train_clipvision.npy', mmap_mode='r')
test_clip = np.load('cache/eyetracking_data/simonPilotResults/extracted_embeddings/test_clipvision.npy', mmap_mode='r')
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
# np.save(save_dir + 'eyetracking_regress_clipvision.npy', pred_clip)
np.save(save_dir + 'eyetracking_regress_clipvision_delay.npy', pred_clip)
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
# with open(save_dir + 'eyetracking_regress_clipvision_weights.pkl', "wb") as f:
#     pickle.dump(datadict,f)
with open(save_dir + 'eyetracking_regress_clipvision_weights_delay.pkl', "wb") as f:
    pickle.dump(datadict,f)