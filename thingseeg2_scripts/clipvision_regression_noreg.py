...
for i in range(num_embed):
    ...
    reg = skl.Ridge(alpha=0, max_iter=50000, fit_intercept=True) # old alpha=60000, optimal alpha=300000, 0 for no regularization
...
np.save(save_dir + 'thingseeg2_regress_clipvision_800ms_noreg.npy', pred_clip)
...
#     pickle.dump(datadict,f)
with open(save_dir + 'thingseeg2_regress_clipvision_weights_800ms_noreg.pkl', "wb") as f:
    pickle.dump(datadict,f)
