...
train_fmri = train_meg_flattened
test_fmri = test_meg_flattened
...
## Regression
num_samples,num_embed,num_dim = train_meg.shape
...
reg.fit(train_clip_flattened, train_fmri)
reg_w = reg.coef_
reg_b = reg.intercept_

# pred_test_latent = reg.predict(test_fmri)
pred_test_latent = reg.predict(test_clip_flattened)
std_norm_test_latent = (pred_test_latent - np.mean(pred_test_latent,axis=0)) / np.std(pred_test_latent,axis=0)
pred_clip_flattened = std_norm_test_latent * np.std(train_meg_flattened,axis=0) + np.mean(train_meg_flattened,axis=0)
# pred_clip_flattened = pred_test_latent
# pred_clip_flattened = std_norm_test_latent
pred_clip = pred_clip_flattened.reshape(test_meg.shape)

for i in range(num_embed):
    # Compute the Euclidean distances
    euclidean_distances = np.array([np.linalg.norm(u - v) for u, v in zip(pred_clip[:,i], test_meg[:,i])])
    correlation_distances = np.array([correlation(u, v) for u, v in zip(pred_clip[:,i], test_meg[:,i])])
...
# Compute the Euclidean distances
euclidean_distances = np.array([np.linalg.norm(u - v) for u, v in zip(pred_clip_flattened, test_meg_flattened)])
correlation_distances = np.array([correlation(u, v) for u, v in zip(pred_clip_flattened, test_meg_flattened)])
# Compute the average Euclidean distance
average_euclidean_distance = euclidean_distances.mean()
correlations = (1 - correlation_distances).mean()

print(average_euclidean_distance, correlations)
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
# np.save(save_dir + 'thingseeg2_regress_cliptext_200ms_1regressor.npy', pred_clip)
# np.save(save_dir + 'thingseeg2_regress_cliptext_400ms_1regressor.npy', pred_clip)
# np.save(save_dir + 'thingseeg2_regress_cliptext_600ms_1regressor.npy', pred_clip)
# np.save(save_dir + 'thingseeg2_regress_cliptext_800ms_1regressor.npy', pred_clip)
# np.save(save_dir + 'thingseeg2_regress_cliptext_200ms_1regressor_0a.npy', pred_clip)
# np.save(save_dir + 'thingseeg2_regress_cliptext_400ms_1regressor_0a.npy', pred_clip)
# np.save(save_dir + 'thingseeg2_regress_cliptext_600ms_1regressor_0a.npy', pred_clip)
np.save(save_dir + 'thingseeg2_regress_cliptext_800ms_1regressor_inverted.npy', pred_clip)
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_200ms_1regressor.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_400ms_1regressor.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_600ms_1regressor.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_800ms_1regressor.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_200ms_1regressor_0a.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_400ms_1regressor_0a.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_600ms_1regressor_0a.pkl', "wb") as f:
#     pickle.dump(datadict,f)
# with open(save_dir + 'thingseeg2_regress_cliptext_weights_800ms_1regressor_inverted.pkl', "wb") as f:
#     pickle.dump(datadict,f)
