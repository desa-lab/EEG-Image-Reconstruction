...
image_path = 'data/things-eeg2_preproc/train_images.npy'
...
if not os.path.exists('cache/thingseeg2_preproc/extracted_embeddings'):
    os.makedirs('cache/thingseeg2_preproc/extracted_embeddings')
np.save('cache/thingseeg2_preproc/extracted_embeddings/train_autokl.npy', train_latents)
np.save('cache/thingseeg2_preproc/extracted_embeddings/test_autokl.npy', test_latents)
