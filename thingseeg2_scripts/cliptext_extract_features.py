...
train_caps = np.load('data/things-eeg2_preproc/train_concepts.npy', mmap_mode='r') 
...
with torch.no_grad():
    ...
    np.save('cache/thingseeg2_preproc/extracted_embeddings/test_cliptext.npy',test_clip)
    ...
    np.save('cache/thingseeg2_preproc/extracted_embeddings/train_cliptext.npy',train_clip)
