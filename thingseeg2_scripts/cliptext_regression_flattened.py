...
reg = skl.Ridge(alpha=0, max_iter=50000, fit_intercept=True) # old alpha=100000, optimal alpha=1200000
...
np.save(save_dir + 'thingseeg2_regress_cliptext_800ms_1regressor_0a.npy', pred_clip)
...
#     pickle.dump(datadict,f)
with open(save_dir + 'thingseeg2_regress_cliptext_weights_800ms_1regressor_0a.pkl', "wb") as f:
    pickle.dump(datadict,f)
