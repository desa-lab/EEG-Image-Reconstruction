...
# pred_text = np.load('cache/predicted_embeddings/BIGMEG1/thingsmeg_brainmodule_cliptext1b_sub-BIGMEG1.npy')
pred_text = np.load('cache/predicted_embeddings/BIGMEG1/thingsmeg_brainmodule_cliptext1bcategory_sub-BIGMEG1.npy')
...
for im_id in range(len(pred_vision)):
    ...
    # if not osp.exists('results/versatile_diffusion1b_brainmodule/{}/'.format(sub)):
