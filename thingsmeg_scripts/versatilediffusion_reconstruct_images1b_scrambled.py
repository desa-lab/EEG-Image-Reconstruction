...
# pred_text = np.load('cache/predicted_embeddings/BIGMEG1/thingsmeg_regress_cliptext1b_scrambled_sub-BIGMEG1.npy')
# pred_text = np.load('cache/extracted_embeddings/BIGMEG1/test_cliptext1b_scrambled_sub-BIGMEG1.npy')
pred_text = np.load('cache/extracted_embeddings/BIGMEG1/test_cliptext1b_sub-BIGMEG1.npy')
...
for im_id in range(len(pred_vision)):
    ...
    # if not osp.exists('results/versatile_diffusion1b_scrambled/{}/'.format(sub)):
    #     os.makedirs('results/versatile_diffusion1b_scrambled/{}/'.format(sub))
    # x[0].save('results/versatile_diffusion1b_scrambled/{}/{}.png'.format(sub,im_id))
    # if not osp.exists('results/versatile_diffusion1b_scrambled_test/{}/'.format(sub)):
    #     os.makedirs('results/versatile_diffusion1b_scrambled_test/{}/'.format(sub))
    # x[0].save('results/versatile_diffusion1b_scrambled_test/{}/{}.png'.format(sub,im_id))
    if not osp.exists('results/versatile_diffusion1b_unscrambled_test/{}/'.format(sub)):
        os.makedirs('results/versatile_diffusion1b_unscrambled_test/{}/'.format(sub))
    x[0].save('results/versatile_diffusion1b_unscrambled_test/{}/{}.png'.format(sub,im_id))
