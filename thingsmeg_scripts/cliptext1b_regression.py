...
train_clip = np.load('cache/extracted_embeddings/BIGMEG1/train_cliptext1b_sub-BIGMEG1.npy', mmap_mode='r')
test_clip = np.load('cache/extracted_embeddings/BIGMEG1/test_cliptext1b_sub-BIGMEG1.npy', mmap_mode='r')
...
np.save(save_dir + f'thingsmeg_regress_cliptext1b_sub-{subject}.npy', pred_clip)
...
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
with open(save_dir + f'thingsmeg_regress_cliptext1b_weights_sub-{subject}.pkl', "wb") as f:
    pickle.dump(datadict,f)