...
image_path = 'cache/processed_data/BIGMEG1/train_images_sub-BIGMEG1.npy'
...
image_path = 'cache/processed_data/BIGMEG1/test_images_sub-BIGMEG1.npy'
...
np.save('cache/extracted_embeddings/BIGMEG1/train_autokl_sub-BIGMEG1.npy', train_latents)
np.save('cache/extracted_embeddings/BIGMEG1/test_autokl_sub-BIGMEG1.npy', test_latents)
