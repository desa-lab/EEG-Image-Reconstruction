...
train_latents = np.load('cache/extracted_embeddings/BIGMEG1/train_autokl_sub-BIGMEG1.npy', mmap_mode='r')
test_latents = np.load('cache/extracted_embeddings/BIGMEG1/test_autokl_sub-BIGMEG1.npy', mmap_mode='r')
